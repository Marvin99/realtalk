package com.AirMag.AirMag.facebookSignIn;
...
public class FacebookHelper {
    private login.social.sample.facebookSignIn.FacebookResponse mListener;
     ...
     */
    public FacebookHelper(@NonNull login.social.sample.facebookSignIn.FacebookResponse responseListener,
